...
export default function Modals() {
  ...
  return (
    <>
      <div className="avatar-modals" onMouseEnter={handleHover} onMouseLeave={handleLeave}>
      ...
      {activeModal === 'signIn' && <SignInModals onClose={closeModal} openSignUp={() => openModal('signUp')} />}
      {activeModal === 'signUp' && <SignUpModals onClose={closeModal} openSignIn={() => openModal('signIn')}/>}
    </>
  );
}
